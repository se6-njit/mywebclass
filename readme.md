...
1. Partner 1: [Stephen Ebrahim](https://github.com/se6-njit) <- Team Leader
2. Partner 2: [Ebram Mekhail](https://github.com/EbramMekhail) <- Member
3. Partner 3: [Aryan Nesti](https://github.com/AryanNesti) <- Member
